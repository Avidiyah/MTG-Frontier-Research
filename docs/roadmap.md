...
| D16 | Exclude `can't be prevented` statics from `prevention_effect` (P-ATQ-2) | Implemented 2026-08-26; fresh combined S11: 166 `prevention_effect` units, 0 prohibition misfires. Awaiting research-lead acceptance. | Implemented, pending review | Codex → research lead |
| D17 | Strip ability-word / Saga-chapter / named-mode prefixes before kind classification (P-ATQ-3) | Implemented 2026-08-26; fresh S11 reduces 8 prefix-related prevention candidates to 3, pending lead adjudication. | Implemented, pending review | Codex → research lead |
| D18 | Spell-only delayed triggers on instant/sorcery faces get role `delayed_trigger` (P-ATQ-4) | Implemented 2026-08-26; fresh S11 finds exactly 30 top-level delayed-trigger roles and 861 distinct nested children. | Implemented, pending review | Codex → research lead |
