...
| D15 | Retract split rule (c): never split at a trigger-condition comma or cost colon or inside quotes; keep the unit whole and record the delayed trigger as a slot/signal (P-ATQ-1) | Implemented 2026-08-26; fresh S11: 861 sentence-level children, 0 comma/colon children. Awaiting research-lead re-annotation and acceptance. | Implemented, pending review | Codex → research lead |
