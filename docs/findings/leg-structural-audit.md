...
queried, or annotated for this outline. No empirical conclusion is recorded
below.

## Frozen inputs and audit status

<!-- Populate verbatim from live commands after P-ATQ closes. -->

## Scope and exclusions

<!-- Record eligible non-held-out development scope and aggregate exclusions. -->

## Preregistered hypotheses

<!-- Copy/link the frozen hypotheses without changing them after baseline observation. -->

## Pre-audit baseline

<!-- Record S2 aggregate measurements before reading any eligible card. -->
